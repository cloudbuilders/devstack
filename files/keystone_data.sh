...
#endpointTemplates
$BIN_DIR/keystone-manage $* endpointTemplates add RegionOne nova http://%HOST_IP%:8774/v2/%tenant_id% http://%HOST_IP%:8774/v2/%tenant_id%  http://%HOST_IP%:8774/v2/%tenant_id% 1 1
